...
urlpatterns = [
    ...
    path('return-product/<int:order_id>/<int:product_id>/', views.return_product, name='return-product'),
    path('admin-ret/', views.admin_ret, name='admin-ret'),
    path('process-return-request/<int:request_id>/', views.process_return_request, name='process-return-request'),
